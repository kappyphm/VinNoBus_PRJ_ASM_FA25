 ...
 * @author Admin
 */
@WebServlet(name = "BusDetailServlet", urlPatterns = {"/BusDetailServlet"})
public class BusDetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BusDetailServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BusDetailServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    public String getServletInfo() {
        return "Servlet hiển thị chi tiết thông tin xe buýt";
    }// </editor-fold>
